...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO items (user_id, item_name, description, category, report_type, location, status, date_reported)
            VALUES ('$user_id', '$item_name', '$description', '$category', 'found', '$location', 'pending', '$date_reported')";
    ...
    if(mysqli_query($conn, $sql)){
        ...
        if ($admin_query) {
            while ($admin = mysqli_fetch_assoc($admin_query)) {
                ...
                $msg = "A new found item report has been submitted: $item_name";
...
<div class="container">
    <div class="panel">
        ...
        <p>Help return items to their owners. The item will appear in the catalogue immediately.</p>
